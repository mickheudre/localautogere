<template>
<div id="default" class="relative min-h-screen w-screen"> 
  <header @focusout="hideMenu" :class="menuVisible ? 'bg-gray-900' : 'bg-white'" class="fixed z-50 md:px-12 w-screen md:pt-12 md:bg-white md:flex md:items-center pb-0 md:justify-between">
